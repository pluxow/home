...
**Embedded Signup v2 se deprecó el 15 de octubre de 2026.** Si se arma o ya existe un flujo de onboarding de clientes, usar **v4**.
...
- [ ] Si es coexistence: avisar sobre el límite de 5 mensajes/segundo al dimensionar el chatbot
